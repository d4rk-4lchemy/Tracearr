  ...
  describe('GET /public/streams', () => {
    it('maps Dispatcharr live channel data as the primary media title and uses channel logo', async () => {
      ...
      const session = createMockActiveSession({
        serverId,
        mediaType: 'live',
        mediaTitle: 'Swiat wedlug Kiepskich',
        grandparentTitle: null,
        thumbPath: '/fallback/program.png',
        channelTitle: 'Mocny Full Klasyk Kurde TV',
        channelThumb: 'https://dispatcharr.homeofkitku.xyz/api/channels/logos/4671/cache/',
        server: {
          id: serverId,
          name: 'Dispatcharr',
          type: 'dispatcharr',
      ...
      expect(body.data[0]).toMatchObject({
        mediaType: 'live',
        mediaTitle: 'Mocny Full Klasyk Kurde TV',
          ...
          rows: [
            {
              ...
              media_type: 'live',
              media_title: 'Swiat wedlug Kiepskich',
              ...
              track_number: null,
              disc_number: null,
              channel_title: 'Mocny Full Klasyk Kurde TV',
              channel_thumb: 'https://dispatcharr.homeofkitku.xyz/api/channels/logos/4671/cache/',
